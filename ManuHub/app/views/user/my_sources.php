...
<head>
    ...
    <title>My Sources - ManuHub</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        /* SOURCE LINK STYLING */
        .source-link { display: inline-flex; align-items: center; gap: 6px; color: #e67e22; text-decoration: none; font-weight: 600; transition: 0.2s; font-size: 13px; }
        .source-link:hover { color: #d35400; text-decoration: underline; }
...
<div class="sidebar">
    ...
    <a href="index.php?action=my_sources" class="menu-item active">
...
<div class="main-content">
    <div class="page-header">
        <h2 class="page-title">My Proposed Sources</h2>
    </div>

    <div class="filter-bar">
        <i class="bi bi-search" style="color: #999;"></i>
        <input type="text" id="searchInput" class="search-input" placeholder="Search by source title or manuscript..." onkeyup="filterUserTable()">
    ...
    <div class="card">
        <table class="user-table" id="sourcesTable">
            <thead>
                <tr>
                    <th width="30%">Source Title</th>
                    <th width="25%">Manuscript Target</th>
                    <th width="20%">Link Preview</th>
            ...
            <tbody>
                <?php if (!empty($data['list'])): ?>
                    <?php foreach ($data['list'] as $row): ?>
                        <tr class="item-row" data-status="<?php echo strtolower($row['status']); ?>">
                            <td>
                                ...
                                <div style="font-size: 11px; color: #999;">Type: Community Research</div>
                            </td>
                            <td>
                                <div style="font-weight: 500; color: #555;"><?php echo htmlspecialchars($row['manuscript_title']); ?></div>
                                <div style="font-size: 11px; color: #bbb;">ID: #<?php echo $row['manuscript_id']; ?></div>
                            </td>
                            <td>
                                <a href="<?php echo $row['url']; ?>" target="_blank" class="source-link">
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr id="emptyRow"><td colspan="5" style="text-align: center; padding: 60px; color: #999;">No related works submitted yet.</td></tr>
                <?php endif; ?>
