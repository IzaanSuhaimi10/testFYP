...
<body>
    ...
    <div class="sidebar">
        <div class="brand"><div class="brand-logo"><i class="bi bi-book-half"></i></div> MANUHUB</div>
        <a href="index.php?action=user_dashboard" class="menu-item"><i class="bi bi-grid-fill"></i> Dashboard</a>
        <a href="index.php?action=submit_manuscript" class="menu-item active"><i class="bi bi-plus-square-fill"></i> Submit New</a>
