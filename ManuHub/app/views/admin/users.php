...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="index.php?action=admin_users" class="menu-item active"><i class="bi bi-people-fill"></i> Users</a>
        ...
        <div class="header-section">
            ...
            <div class="top-controls">
                <div class="filter-pills">
                    ...
                    <div class="pill" onclick="filterByRole('user', this)">Researchers</div>
                            ...
                            <tr class="user-row" data-role="<?php echo strtolower($u['role']); ?>">
                                ...
                                <td>
                                    <?php 
                                        ...
                                        if($u['role'] === 'user') $roleLabel = 'researcher';
                                    ?>
