...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="index.php?action=expert_dashboard" class="menu-item"><i class="bi bi-grid-fill"></i> Dashboard</a>
        <a href="index.php?action=expert_profile" class="menu-item"><i class="bi bi-person-gear"></i> Edit Profile</a>
        <a href="index.php?action=expert_verification_manuscripts" class="menu-item active"><i class="bi bi-file-earmark-text"></i> Manuscripts</a>
        <a href="index.php?action=expert_verification_related" class="menu-item"><i class="bi bi-link-45deg"></i> Sources</a>
