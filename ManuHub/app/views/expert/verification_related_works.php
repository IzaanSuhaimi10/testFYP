...
<body>
    ...
    <div class="sidebar">
        ...
        <a href="index.php?action=expert_verification_manuscripts" class="menu-item"><i class="bi bi-file-earmark-text"></i> Manuscripts</a>
        <a href="index.php?action=expert_verification_related" class="menu-item active"><i class="bi bi-link-45deg"></i> Sources</a>
