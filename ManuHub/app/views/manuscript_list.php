...
<style>
    ...
    .pagination-btn {
        padding: 10px 20px;
        margin: 0 8px;
        background-color: #6FB1B3;  /* Elegant muted teal for all page buttons */
        border: none;
    ...
    .pagination-btn:hover {
        background-color: #4E9A9B;  /* Slightly darker, refined teal on hover */
        transform: translateY(-5px);  /* Subtle upward effect when hovered */
    }

    .pagination-btn.active {
        background-color: #2C6B6F; /* Rich, contrasting navy blue for active page */
        font-weight: bold;
    ...
    .pagination-ellipsis {
        padding: 12px 24px;
        color: #6FB1B3;  /* Match the elegant muted teal for ellipsis */
        font-weight: bold;
    }
