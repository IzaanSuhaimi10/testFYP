                    ...
                    <div class="tab-pane fade" id="related-work">
                                    ...
                                    <li class="list-group-item">
                                        <div class="d-flex w-100 justify-content-between align-items-center">
                                            ...
                                            <span class="badge <?php echo $badgeClass; ?> flex-shrink-0" style="min-width: 110px; text-align: center;">
                                                <?php echo htmlspecialchars($work['category'] ?? 'Resource'); ?>
                                            </span>
                                        </div>
                        ...
                        <?php if (isset($_SESSION['user_id'])): ?>
                            <div class="card border-0 bg-light shadow-sm">
                                <div class="card-body p-4">
                                    <h5 class="card-title text-dark fw-bold mb-3"><i class="bi bi-plus-circle-fill text-primary me-2"></i>Contribute a Resource</h5>
                                    <p class="text-muted small mb-3">Found a digitized version or a research paper? Submit it here.</p>
                                    ...
                                    <form action="index.php?action=submit_related_work" method="POST">
                                        ...
                                        <div class="row g-3 align-items-end">
                                            <div class="col-md-5">
                                                ...
                                                <input type="text" name="work_title" class="form-control" placeholder="e.g. PDF from National Library" required>
                                            </div>
                                            <div class="col-md-5">
                                                <label class="form-label small fw-bold text-secondary">Link (URL)</label>
                        ...
                        <?php else: ?>
                            <div class="alert alert-light text-center border" role="alert">
                                Know a related resource? <a href="index.php?action=login" class="fw-bold text-decoration-none">Login</a> to contribute.
                            </div>
                        <?php endif; ?>
                    </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        function drawGraph() {
            ...
            <?php if (!empty($data['connections'])): ?>
                <?php foreach ($data['connections'] as $conn): ?>
                    ...
                    nodes.push({
                        ...
                        font: { size: 14, color: '#333', background: 'white' },
                        shape: 'dot',
                        size: 25,
                        shadow: true
                    });
            ...
            var options = {
                nodes: { borderWidth: 2, shapeProperties: { interpolation: false } },
                edges: { width: 1, color: { color: '#bdc3c7', opacity: 0.6 }, smooth: { type: 'continuous' } },
                physics: { 
                    solver: 'forceAtlas2Based',
                    forceAtlas2Based: { gravitationalConstant: -100, centralGravity: 0.005, springConstant: 0.08, springLength: 200, damping: 0.4, avoidOverlap: 1 },
