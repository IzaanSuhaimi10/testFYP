    ...
    <table class="table table-bordered">
        ...
        <tr><th class="bg-light">Genre</th><td><?php echo htmlspecialchars($data['manuscript']['Genre']); ?></td></tr>
                    ...
                    <div class="tab-pane fade" id="location">
                        <table class="table table-bordered">
                            <tr><th class="bg-light w-25">Country</th><td><?php echo htmlspecialchars($data['manuscript']['Country']); ?></td></tr>
                            <tr><th class="bg-light">Current Repository</th><td><?php echo htmlspecialchars($data['manuscript']['Location_of_Manuscript']); ?></td></tr>
